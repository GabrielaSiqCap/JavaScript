...
var texto4 = "Olá, meu nome é Gabriela!";
console.log(`Tamanho do texto: ${texto4.length} caracteres!`);

//Caracteres de escape
var texto5 = 'Olá, meu nome é "Gabriela"!';
console.log(texto5);
...
//limpando espaços em branco (Método termina)
var texto11 = "             Texto aqui no meio                    "
console.log(`*******`, texto11, `*******`);
console.log(`*******`, texto11.trim(), `*******`);

//Buscando a posição de uma posição de uma string (Método indexOf)
