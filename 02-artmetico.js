//utilizando operadores aritmeticos com JavaScript

console.log("A soma entre 8 e 7 é:", 8 + 7);

//efetuar a soma de dois numeros informados por você (var nome_variavel = 12)
...
console.log("-------------");
console.log("Resto da divisão ineteira: v1 % v2 =", v1 % v2);
